...
class DefaultController extends Controller
{
	...
	public function validarAction(Request $request){
		...
		if ($respuesta===false){
			...
			$this->get('session')->setFlash('error', 'El comprobante contiene errores!');
			return $this->render('AcmeFacturacionBundle:bussiness_template:validar.html.twig', array('errores' => $errores) );
		}else{
			$this->get('session')->setFlash('notice', 'El comprobante es valido!');
			return $this->render('AcmeFacturacionBundle:bussiness_template:validar.html.twig');
		}
